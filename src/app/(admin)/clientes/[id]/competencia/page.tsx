      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div className="min-w-0">
            ...
            <h1 className="font-display font-extrabold text-[clamp(1.4rem,2.5vw,2.4rem)] tracking-tight leading-[1.05] text-foreground flex items-center gap-3">
              <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 text-ds-yellow shrink-0" />
              Competencia
            </h1>
